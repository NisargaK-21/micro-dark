        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-4 sm:p-6">
          ...
          <div className="space-y-3">
            {activity && activity.length > 0 ? activity.map((item) => (
              <div
                key={item.id}
                className="flex flex-col sm:flex-row items-start justify-between p-3 sm:p-4 bg-zinc-50 dark:bg-zinc-800 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors gap-2 sm:gap-0"
              >
